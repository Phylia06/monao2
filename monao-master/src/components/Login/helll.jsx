   ...
   const handleSubmit = async (e) => {
      ...
      try {
         ...
         if (isSignup) {
            ...
            navigate('/bookticket'); // Navigate to /bookticket after login
         }
      } catch (error) {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
               ...
               <div className="flex flex-col">
                  ...
                  <input
                     ...
                     className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-violet-500 dark:text-black"
                     required
                  />
               </div>
